...
function riew(viewFunc) {
  ...
  var renderer = Renderer(function (value) {
    viewFunc(value);
    if (__DEV__) _index.logger.log(api, 'RIEW_RENDERED', value);
  });
  var api = {
  ...
  api.mount = function () {
    ...
    if (__DEV__) _index.logger.log(api, 'RIEW_MOUNTED', props);
  };
  ...
  api.unmount = function () {
    ...
    if (__DEV__) _index.logger.log(api, 'RIEW_UNMOUNTED');
  };
  ...
  api.update = function () {
    ...
    (0, _utils.requireObject)(props);
    (0, _index.sput)(PROPS_CHANNEL, props);
    if (__DEV__) _index.logger.log(api, 'RIEW_UPDATED', props);
  };
  ...
  _index.grid.add(api);
  if (__DEV__) _index.logger.log(api, 'RIEW_CREATED');
