...
function state() {
  ...
  var api = {
        ...
        try {
          if ((0, _utils.isGeneratorFunction)(reducer)) {
            (0, _index.go)(reducer, function (genResult) {
              ...
              if (__DEV__) _index.logger.log(api, 'STATE_VALUE_SET', value);
            }, value, payload);
            return;
          }
    ...
    destroy: function destroy() {
      ...
      if (__DEV__) _index.logger.log(api, 'STATE_DESTROYED');
      return this;
    },
    get: function get() {
      return value;
    ...
    set: function set(newValue) {
      ...
      if (__DEV__) _index.logger.log(api, 'STATE_VALUE_SET', newValue);
      return newValue;
    }
  };
  ...
  _index.grid.add(api);
  if (__DEV__) _index.logger.log(api, 'STATE_CREATED');
